...
| 주소   | …   | 1002              | 1003              | 1004                   | 1005                 | …   |
| ------ | --- | ----------------- | ----------------- | ---------------------- | -------------------- | --- |
| 데이터 |     | `식별자: a` @5002 | `식별자: b` @5001 | `식별자: obj1` @7002 ~ | `식별자: obj2` @7002 |     |
...
| 주소   | …   | 1002              | 1003              | 1004                   | 1005                 | …   |
| ------ | --- | ----------------- | ----------------- | ---------------------- | -------------------- | --- |
| 데이터 |     | `식별자: a` @5002 | `식별자: b` @5004 | `식별자: obj1` @7002 ~ | `식별자: obj2` @7002 |     |
...
원시형은 15를 @5004에 새롭게 공간을 확보하고 b 식별자의 주소를 업데이트합니다. 하지만 참조형 데이터의 복사는 조금 다릅니다. 20은 새롭게 공간을 5005@에 확보합니다. 그리고 c프로퍼티 식별자의 주소는 20을 바라봅니다.
