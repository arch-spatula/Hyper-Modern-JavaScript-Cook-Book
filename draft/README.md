...
만약에 다른 이름을 붙여야 한다면 하이퍼 모든 자바스크립트라고 해야 할 것 같습니다. 자바스크립트를 체스에 비유하자면 es5는 고전시대였습니다. 그리고 es6는 근현대의 분기점이었습니다. 그리고 저는 자바스크립트 활용의 하이퍼 모더니즘으로 접근할 것입니다. 그래서 이상한 부분을 많이 다룰 것입니다.
...
자바스크립트를 해석하는 문헌들이 많습니다. 결국 그 문헌들도 해석입니다. 신뢰할 수 없습니다. 항상 ECMAScript spec을 직접 읽도록 합니다. MDN도 모던자바스크립트 튜토리얼도 결국 성서해석에 불과합니다. 그리고 각각의 종파마다 다른 해석할 가능성은 여전히 존재합니다. 이 리포지토리 또한 해당합니다.
